...
named_run_list :boxcutter_python_test_pyenv, %w{boxcutter_ohai boxcutter_init boxcutter_python_test::pyenv}
named_run_list :boxcutter_python_test_system, %w{boxcutter_ohai boxcutter_init boxcutter_python_test::system}
