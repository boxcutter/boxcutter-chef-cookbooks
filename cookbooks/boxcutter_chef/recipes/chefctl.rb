...
node.default['fb_timers']['jobs']['chef'] = {
  ...
  'command' => '/bin/sh -c "/usr/bin/test -f /var/chef/cron.default.override -o ' +
    "-f #{confdir}/test_timestamp || /usr/local/sbin/chefctl -q -q >/dev/null 2>&1\"",
  'service_options' => {
