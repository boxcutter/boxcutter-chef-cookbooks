# Policyfile.connect_server.rb - Describe how you want Chef Infra Client to build your system.
#
...
run_list 'boxcutter_ohai', 'boxcutter_init', 'boxcutter_onepassword_test::connect_server'
