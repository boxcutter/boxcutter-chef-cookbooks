...
case node['platform']
when 'ubuntu'
  node.default['fb_apt']['sources']['tailscale'] = {
    'key' => 'tailscale',
  ...
  # curl -fsSLO https://pkgs.tailscale.com/stable/ubuntu/noble.noarmor.gpg
  # gpg --enarmor < noble.noarmor.gpg > tailscale-archive-keyring.asc
  node.default['fb_apt']['keymap']['tailscale'] = <<~EOS
