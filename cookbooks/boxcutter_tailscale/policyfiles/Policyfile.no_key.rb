# Policyfile.no_key.rb - Describe how you want Chef Infra Client to build your system.
#
...
run_list 'boxcutter_ohai', 'boxcutter_init', 'boxcutter_tailscale_test::no_key'
