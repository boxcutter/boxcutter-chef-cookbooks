# Policyfile.oauth_client.rb - Describe how you want Chef Infra Client to build your system.
#
...
run_list 'boxcutter_ohai', 'boxcutter_init', 'boxcutter_tailscale_test::oauth_client'
